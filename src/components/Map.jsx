...
const MapComponent = ({
  ...
  const matchingHighlightedTowns = highlightedCities
    .map((city) => {
  ...
  useEffect(() => {
    ...
    if (
      !geojsonData ||
      !Array.isArray(highlightedCities) ||
      ...
      >
        ...
        {geojsonData && (
          <Source
            id="massachusetts"
            type="geojson"
            data={choroplethData || geojsonData}
          >
            ...
            <Layer
              ...
              paint={{
                "fill-color":
                  viewMode === "geographicCount" ? "#86efac" : "#3b82f6", // Light green for geographic mode, blue for city mode
                "fill-opacity": 0.5,
              }}
              filter={
                matchingHighlightedTowns.length > 0
                  ...
                  : selectedCity &&
                    selectedCity.toLowerCase().includes("state-wide")
                ...
                filter={
                  matchingHighlightedTowns.includes("STATE_WIDE_SPECIAL")
                    ...
                    : [
                        "in",
                        ["get", "town"],
                        ["literal", getAllHighlightedTowns()],
                      ]
                }
              />
            )}
        ...
        {clickedTooltipInfo && clickTooltipPosition && (
          ...
          >
            <div className="p-3">
              ...
              {viewMode === "year" &&
                clickedTooltipInfo.feature.properties.projectCount !==
                  undefined && (
                  <div className="mt-1 text-xs text-gray-500">
                    {clickedTooltipInfo.feature.properties.projectCount} project
                    {clickedTooltipInfo.feature.properties.projectCount !== 1
                      ? "s"
                      : ""}{" "}
                    ({selectedYear})
                  </div>
